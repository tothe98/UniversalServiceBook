                            ...
                            <Grid container gap={2} justifyContent="flex-end" alignItems="center">
                                <Grid item>
                                    <Grid container direction="row" justifyContent="center" alignItems="center">
                                        <Grid item>
                                            <Typography sx={{ color: "#fff" }} variant="body1">{currentImageIndex+1}/{images.length}</Typography>
                                        </Grid>
                                        <Grid item>
                                ...
                                <Grid item>
                                    {
                                        isURL
                                        ?
                                        <ViewImage src={(""+currentImage).includes("http") ? currentImage : `${process.env.REACT_APP_CLIENT_URL}/${currentImage}`} />
                                        :
