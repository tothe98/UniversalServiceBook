...
import { serviceInformationIcon } from "../lib/GlobalIcons";
...
function InformationCard({ data, i, handleChangeTab }) {
  ...
  return (
    <ContentBox key={uuidv4()}>
      <Grid
        container
        spacing={2}
        direction={underS ? "column" : "row"}
        alignItems="center"
      ...
      >
        <Grid item xs={1}>
          ...
          >
            <ContentBoxImage
              src={serviceInformationIcon}
              alt="Szerviz információ"
        ...
        <Grid item xs={10} sx={{ maxWidth: "628px", height: "auto" }}>
          ...
          >
            <Grid item>
              <Typography
                variant="h5"
                sx={{ textAlign: "justify", maxWidth: "500px" }}
        ...
        <Grid
          ...
          xs
          sx={{
            position: underS ? "block" : "absolute",
            bottom: "2em",
            right: "2em",
          }}
        >
