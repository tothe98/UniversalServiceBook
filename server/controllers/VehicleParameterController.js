...
exports.getCategories = async (req, res) => {
    try {
        const VehicleType = mongoose.model('VehicleTypes')
        const responseFromDB = await VehicleType.find({ isActive: true })
            .then((response) => {
...
exports.addManufacture = async (req, res) => {
    ...
    try {
        ...
        if (isExistCategory) {
            const isExistManufacture = await Manufacture.findOne({ manufacture: manufacture, _vehicleType: vehicleType })
...
exports.addModel = async (req, res) => {
    ...
    try {
        const Models = mongoose.model('Models')
        const Manufacture = mongoose.model('Manufactures')
        const isExistManufacture = await Manufacture.findOne({ _id: manufacture })
