...
const { Workshops, Users, Vehicles, ServiceEntries, Pictures, RecentActivations } = require("../core/DatabaseInitialization");
        ...
        try {
            ...
            if (vehicle.isActive == true) {
                const recentActivation = await RecentActivations.create({
                    ...
                    text: `Új szervizbejegyzés lett rögzítve az ön ${vehicle._manufacture.manufacture} ${vehicle._model.model} (alvz.szm.:${vehicle.vin}) járművéhez a(z) ${workshop.name} műhely által!`,
                    vehicle: `${vehicle._manufacture.manufacture} ${vehicle._model.model}`,
                    vin: vehicle.vin,
